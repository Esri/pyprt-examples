...
* Python 3.8 64bit or later. Please note, we currently provide PyPRT builds for Python 3.8, 3.9 and 3.10(*). For other Python versions, please [build](https://github.com/Esri/pyprt) PyPRT yourself.
...
1. Ensure you have a working Anaconda Python 3.8, 3.9 or 3.10 64bit installation. For other Python versions, please [build](https://github.com/Esri/pyprt) PyPRT yourself at the moment.
